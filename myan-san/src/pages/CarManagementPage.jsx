        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div className="mb-8 flex justify-center">
            <div className="w-full md:w-2/3 lg:w-1/2">
              <label htmlFor="selectCarNo" className="block text-xl font-bold text-gray-800 mb-3 text-center">
              ...
              <select
                ...
                className="mt-1 block w-full rounded-lg border-2 border-blue-400 shadow-lg focus:border-blue-600 focus:ring-blue-600 text-lg p-3 text-center bg-blue-50"
              >
          ...
          {selectedCarNo && (
            <>
              ...
              <Collapse in={showFilterOptions}>
                <Box className="p-4 mb-4 bg-gray-100 rounded-lg shadow-inner flex flex-wrap gap-4 items-center">
                  <FormControl variant="outlined" size="small" className="w-[150px]">
                    <InputLabel>လ ရွေးပါ</InputLabel>
                    <Select
                      value={filterMonth}
                  ...
                  <FormControl variant="outlined" size="small" className="min-w-[120px]">
                    <InputLabel>နှစ် ရွေးပါ</InputLabel>
                    <Select
                      value={filterYear}
                  ...
                  {activeTab === 'maintenance' && (
                    <>
                      <FormControl variant="outlined" size="small" className="w-[350px]">
                        <InputLabel>ဖော်ပြချက် (ထိန်းသိမ်း)</InputLabel>
                        <Select
                  ...
                  {activeTab === 'general' && (
                    <>
                      <FormControl variant="outlined" size="small" className="w-[350px]">
                        <InputLabel>ဖော်ပြချက် (အထွေထွေ)</InputLabel>
                        <Select
                    ...
                    <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm">
                      <thead>
                        <tr className="bg-gray-100 border-b border-gray-200">
                          ...
                          <th className="px-4 py-2 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">လုပ်ဆောင်ချက်</th> {/* Action column */}
                        </tr>
                      </thead>
                      <tbody>
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm">
                      <thead>
                        <tr className="bg-gray-100 border-b border-gray-200">
                          <th className="px-4 py-2 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">No.</th>
                          <th className="px-4 py-2 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">ရက်စွဲ/အချိန်</th> {/* Changed header */}
                      ...
                      <tbody>
                        {fuelLogs.length === 0 ? (
                          ...
                          fuelLogs.map((log, index) => (
                            <tr key={log.id} className="border-b border-gray-200 hover:bg-gray-50">
                              <td className="px-4 py-2 text-sm text-gray-800">{index + 1}</td>
                              <td className="px-4 py-2 text-sm text-gray-800">{log.log_datetime}</td> {/* Changed to log_datetime */}
                        ...
                        <tr className="bg-gray-100 font-bold border-t-2 border-gray-300">
                          <td colSpan="4" className="px-4 py-2 text-right text-sm text-gray-800">
